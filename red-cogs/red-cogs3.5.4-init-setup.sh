...
echo "THIS SCRIPT IS EXPIREMENTAL!"
echo "THERE IS NO GUARANTEE THAT THIS SCRIPT WILL WORK!"
echo "THIS SCRIPT ISN'T RESPONSIBLE FOR ANY DAMAGE CAUSED TO YOUR PI! (However unlikely that will be)"
...
echo "1 for pi0 and pi1 | 4 for pi2 and pi3"
echo -n ">"
read redcores
echo "-----"
